...
export default function AuthButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-lg bg-white border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700"
    >
